...
def monthly_expenditure_amount(accountid): #monthly expenditure without tags
    ...
    cleaned_monthly_amount = {}

    for key, value in monthly_amount_exp.items():
        cleaned_monthly_amount[key] = str("{:.2f}".format(value))

    return cleaned_monthly_amount

print(monthly_expenditure_amount(10))
print(api_getAccountBalance(10))
